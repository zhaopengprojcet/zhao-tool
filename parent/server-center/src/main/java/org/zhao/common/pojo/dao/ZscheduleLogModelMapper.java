...
public interface ZscheduleLogModelMapper extends MapperBase<ZscheduleLogModel>{
    ...
    @Results(value={
		...
		@Result(column="do_error",property="doError",javaType=java.lang.String.class,jdbcType=JdbcType.VARCHAR),
		@Result(column="put_error",property="putError",javaType=java.lang.String.class,jdbcType=JdbcType.VARCHAR),
